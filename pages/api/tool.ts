...
import { RULESET_VERSION, runDeterministicChecks } from '../../lib/rules/meal-nutrition'
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const slug = String((PRODUCT as any).slug || 'meal-planner')
