/* GEO: definitionLead surfaced via product.ts / FAQPage */
...
export default function Home() {
  ...
  const setDemoMode = setUseDemoMode
  ...
  async function runStudio(e?: FormEvent) {
    ...
    try {
      ...
      for (const k of ['homeType', 'timeline', 'budget', 'beds', 'baths', 'location', 'features', 'role', 'seniority', 'client', 'lineItems', 'notes', 'level', 'mustHaves', 'json', 'sample', 'currency', 'taxRate', 'commits', 'text', 'article', 'notes', 'goal', 'topic', 'industry', 'brand', 'resume', 'jd', 'data', 'product', 'client', 'amount', 'tone', 'emails', 'config_text', 'scope', 'feedback']) {
        if (!inputMap[k]) inputMap[k] = topic
      }
      for (const f of fields) {
        if (f?.key && !(f.key in inputMap)) inputMap[f.key] = topic
      }
  ...
  return (
    <>
<Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"FAQPage\", \"mainEntity\": [{\"@type\": \"Question\", \"name\": \"What is MealPlanner?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"MealPlanner is a tool that builds a 7-day meal plan from your goal and dietary restrictions.\"}}, {\"@type\": \"Question\", \"name\": \"How long is the plan?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"It produces a 7-day meal plan.\"}}, {\"@type\": \"Question\", \"name\": \"Does it respect my diet?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Yes. It respects the dietary restrictions you set.\"}}, {\"@type\": \"Question\", \"name\": \"Are the meals complicated?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"The meals are kept simple so you can actually cook them.\"}}, {\"@type\": \"Question\", \"name\": \"Can I print it?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"The plan is copy-or-print for the kitchen or grocery run.\"}}, {\"@type\": \"Question\", \"name\": \"Who should use it?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"People who want to eat better without the spreadsheet and the planning overhead.\"}}]}" }} />

        <title>{`${PRODUCT.name} — ${PRODUCT.tagline}`}</title>
        <meta name="description" content={PRODUCT.description} />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="canonical" href="https://meal-planner.lxsaihub.com/" />
      </Head>
