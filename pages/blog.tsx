...
const howToSteps = [
  { name: 'Open MealPlanner', text: 'Go to the workspace and enter the inputs MealPlanner asks for.' },
  { name: 'Generate the draft', text: 'Run MealPlanner to get a structured plain-English result.' },
  { name: 'Review before you act', text: 'Edit anything that does not match your context. Treat the output as decision support.' },
]
...
export default function Page() {
  ...
  const SHORT = "MealPlanner builds a 7-day meal plan from your goal and dietary restrictions."
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">MealPlanner builds a 7-day meal plan from your goal and dietary restrictions.</p>
