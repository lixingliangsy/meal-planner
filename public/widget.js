 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="meal-planner" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "meal-planner";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "meal-planner") + "_chat_session";
