...
>
> AI-generated, research-backed cold emails for founders and freelancers reaching out to prospects on LinkedIn, X, or email.
...
```bash
npm run build
# Vercel: import repo, set framework = Next.js, root = 12_Micro_SaaS出海/coldmail-ai
```
