...
export const PIPELINE_ID = 'meal-planner-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Goal & dietary restrictions",
  process: "Step 2/3 · Build simple cookable meals",
  output: "Step 3/3 · 7-day copy-or-print plan",
}
